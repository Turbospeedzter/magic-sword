...
class Player extends Phaser.Physics.Arcade.Sprite {
    ...
    init() {
        ...
        this.jumpSound = this.scene.sound.add('jump', {volume: 1.0});
        this.projectileSound = this.scene.sound.add('projectile-launch', {volume: .6});
        this.stepSound = this.scene.sound.add('step', {volume: .7});
        this.swipeSound = this.scene.sound.add('swipe', {volume: .6});
        ...
        this.hp = new HealthBar(
            this.scene,
            this.scene.config.leftTopCorner.x + 20, //ADDED 20px to Phiip's
    ...
    update() {
        ...
        //*************************** Special Up Arrow**************************** */
        if (up.isDown && (onFloor || this.jumpCount < this.consecutiveJumps)) {
            this.jumpSound.play();
    ...
    handleAttacks() {
        ...
        this.scene.input.keyboard.on('keydown-E', () => {
            ...
            this.timeFromLastSwoing = getTimestamp();     
        })
