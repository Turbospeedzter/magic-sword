...
class SpriteEffect extends Phaser.Physics.Arcade.Sprite {
    ...
    constructor(scene, x, y, effectName, impactPosition) {
        ...
        this.target = null;  //tracking the target
        this.effectName = effectName;
        this.impactPosition = impactPosition;//was extended to here.
    ...
    placeEffect() {
        ...
        this.body.reset(center.x, this.impactPosition.y);  //finds the center of the body
