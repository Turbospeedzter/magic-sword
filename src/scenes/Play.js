...
class Play extends Phaser.Scene {
    ...
    create({gameStatus}) {
        ...
        this.playBgMusic();
        this.collectSound = this.sound.add('coin-pickup', {volume: .5});
    ...
    playBgMusic() { 
        if (this.sound.get('gameloop')) { return; }
        this.sound.add('gameloop', {loop: true, volume: .1}).play();  
    ...
    createMap() {
        //this next statement gets the current level dynamically
    ...
    createLayers(map) {
        ...
        map.createStaticLayer('distance', tileset).setDepth(-12);
